        ...
        <div id="msform" class="installment-form">
            <fieldset class="installation">
                <form>
                    <div class="step-title mb-25">
                        <h3>Let's Start Installation for ready <br> Bidout Application!</h3>
                            ...
                            <div class="w-50">
                                <div class="form-inner">
                                    ...
                                    <select name="environment">
                                        ...
                                        <option valuion>e="production">Production</option --}}
                                    </select>
                ...
                <form action="{{ route('install.demo') }}">
                    ...
                    <div class="step-title mb-25">
                        ...
                        <div class="form-input-area">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="demo_import" id="flexCheckChecked" >
            ...
            <fieldset class="Finished {{ request()->is('install/final') ? 'active' : '' }} justify-centent-center">
                ...
                @if (request()->is('install/final'))
                    ...
                    <div class="step-btn-group">
                        <div class="step-btn-group">
                            <a href="{{ url('/') }}" target="__blank" class="next-btn">Frontend Url
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24">
                                    <g>
                                        <path
                        ...
                        <div class="step-btn-group">
                            <a href="{{ url('/admin/login') }}" target="__blank" class="next-btn">Backend Url
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24">
                                    <g>
                                        <path
